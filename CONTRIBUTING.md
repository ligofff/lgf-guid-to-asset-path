...
1. Make an [Issue](https://github.com/ligofff/lgf-guid-to-asset-path/issues/new)
...
```json
    {
        "dependencies": {
            "com.ligofff.lgf-guid-to-asset-path": "https://github.com/YOUR_USER/lgf-guid-to-asset-path.git"
        }
    }
```
